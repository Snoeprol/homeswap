...
import { HomeIcon, SearchIcon, InfoIcon, RepeatIcon, ArrowLeftIcon, ArrowRightIcon } from 'lucide-react';
...
const BrowseHomesPage = () => {
  ...
  const toggleMapExpansion = () => {
    ...
    setMapWidth(isMapExpanded ? 50 : 100);
  };
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="flex mt-6 space-x-4">
          ...
          <div className={`relative transition-all duration-300 ease-in-out ${isMapExpanded ? 'w-full' : 'w-1/2'}`}>
            <MapContainer center={mapCenter} zoom={13} style={{ height: 'calc(100vh - 12rem)', width: '100%' }}>
              <TileLayer
